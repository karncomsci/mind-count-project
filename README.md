...
**สถานะ: PHASE 0 พร้อมหน้าใบเสนอราคาและใบวางบิลตัวอย่าง** มี infrastructure และหน้า frontend สำหรับรายการ/สร้าง/แก้ไขเอกสาร โทนขาว–เทาอ่อน หัวตารางสีฟ้า ปุ่มหลักสีเขียว พร้อมเมนูเอกสารการขาย ระบบ register/login/profile ยังไม่ได้เริ่ม
...
เมนูเอกสารการขายมีครบ **ใบเสนอราคา, ใบวางบิล, ใบกำกับภาษี, ใบเสร็จรับเงิน, ขายเงินสด, ใบลดหนี้ และใบเพิ่มหนี้** อีก 5 ประเภทนอกจากใบเสนอราคาและใบวางบิลมีหน้ารองรับเมนูไว้ก่อน รายละเอียดจะเพิ่มภายหลัง คำสั่งสร้างเอกสารต่อ/แบ่งจ่าย/มัดจำในเมนูสถานะจึงยังไม่เปิดใช้งาน
...
เปิดเมนู **เอกสารการขาย → ใบวางบิล** (`/sales/billing-notes`) แล้วกด **สร้างใบวางบิล** (`/sales/billing-notes/new`)

1. กรอกลูกค้า วันที่ เครดิต รายการสินค้า ราคา ส่วนลด VAT และหัก ณ ที่จ่าย ระบบคำนวณวันครบกำหนดและยอดเงินให้ทันที เช่น ราคาไม่รวมภาษี 20,000 บาท + VAT 7% = 21,400 บาท เมื่อหัก ณ ที่จ่าย 3% จะเหลือยอดชำระ 20,800 บาท
2. เลือกโปรเจ็คหรือคลังสินค้าจาก dropdown; กด **เพิ่มโปรเจ็ค** หรือ **เพิ่มคลังสินค้า** เพื่อกรอกข้อมูลใน dialog เมื่อบันทึกแล้วระบบเลือกค่าที่สร้างให้ทันทีและเก็บไว้ใช้ในเอกสารถัดไป
3. กรอกเลขที่อ้างอิง รายละเอียด หมายเหตุ และโน้ตภายใน แนบ PNG/JPG/PDF ได้ไม่เกิน 3 ไฟล์ ขนาดสูงสุด 1 MB ต่อไฟล์และรวมไม่เกิน 1.5 MB ไฟล์แนบเก็บในเบราว์เซอร์พร้อมเอกสาร
4. กด **บันทึกเอกสาร** เพื่อรับเลข `BLYYYYMMDD0001` แยกลำดับจากใบเสนอราคา; ค้นหาแล้วกดเลขเอกสารเพื่อแก้ไขหรือเปิดซ้ำ การแก้ไขใช้เลขเดิม
5. **พิมพ์** เปิดหน้าพิมพ์ของเบราว์เซอร์; **ดาวน์โหลด** สร้างไฟล์ PDF ภาษาไทย; **แชร์** เตรียมข้อความสรุปให้คัดลอกส่งต่อลูกค้า โน้ตภายในและไฟล์แนบไม่รวมในเอกสารพิมพ์/PDF/ข้อความแชร์
6. ช่อง **แสดงช่องลายเซ็นและตรายาง** เพิ่มพื้นที่สำหรับลงนามบนเอกสารพิมพ์/PDF ไม่ใช่ระบบลงลายมือชื่ออิเล็กทรอนิกส์

ข้อมูลใบวางบิล โปรเจ็ค และคลังสินค้าใช้ `localStorage` แยกจากใบเสนอราคา ยังไม่เชื่อม backend/ฐานข้อมูลและไม่ซิงก์ข้ามเครื่องหรือพอร์ต เมื่อ browser storage เต็มหรืออ่านข้อมูลเดิมไม่ได้ จะแสดงข้อผิดพลาดและไม่เขียนทับข้อมูลเดิม ดู [โครงสร้างใบวางบิล](docs/architecture/billing-notes-frontend.md) สำหรับการแก้โค้ด
