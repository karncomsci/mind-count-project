...
ใบวางบิลสร้าง/แก้ไข คำนวณยอด แนบไฟล์ และบันทึกผ่าน Nuxt → Go → PostgreSQL รวมถึงโปรเจ็คและคลังสินค้า สถานะใช้ ร่าง / รอวางบิล / วางบิลแล้ว / ยกเลิก พร้อมค้นหาขั้นสูง เรียงข้อมูล เลือกหลายรายการ ส่งออก CSV พิมพ์/PDF และลบ/กู้คืน

ตารางทั้ง 7 เมนูใช้หัวตารางเดียวกัน เมนูที่ยังไม่มีฟอร์มสร้างเอกสารแสดงตารางว่าง ใบเสนอราคายังคงเก็บในเบราว์เซอร์ ทั้งสองหน้าฟอร์มที่มีอยู่ใช้ dialog ยืนยันก่อนออกเมื่อแก้ไขข้อมูล

หลังอัปเดตให้ build API และรัน `make migrate-up` ก่อนใช้การบันทึก ข้อมูลใบวางบิลเดิมในเบราว์เซอร์นำเข้าได้จากปุ่ม **นำเข้าข้อมูลเดิม** ระบบเก็บสำเนาไว้หลังนำเข้าสำเร็จ ดู [โครงสร้างและวิธีทดสอบ](docs/architecture/billing-notes-frontend.md)
