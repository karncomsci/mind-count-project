...
## อัปเดตล่าสุด: ตารางทุกเมนูและ backend ใบวางบิล (13 กันยายน 2026)

งานใน `feature/billing-notes-table` ขยายตารางทั้ง 7 เมนู ใช้ dialog ก่อนออกจากฟอร์มใบเสนอราคา/ใบวางบิล และเพิ่ม API + PostgreSQL สำหรับใบวางบิล โปรเจ็ค และคลังสินค้า สถานะล่าสุดที่ผู้ใช้ยืนยันคือ ร่าง / รอวางบิล / วางบิลแล้ว / ยกเลิก ข้อมูลเดิมนำเข้าได้พร้อมเก็บ backup ใบเสนอราคายังใช้ browser storage; อีก 5 เมนูแสดงตารางว่างและยังไม่มีฟอร์มสร้าง

อ่าน [ขอบเขตและผลตรวจล่าสุด](./_bmad-output/implementation-artifacts/billing-notes-table.md) และ [สถาปัตยกรรมล่าสุด](./docs/architecture/billing-notes-frontend.md) ก่อนใช้บันทึกเก่าด้านล่าง ผู้ใช้อนุญาตให้ merge งานเข้า develop หลังตรวจผ่าน ให้ตรวจ Git/PR จริงก่อนเริ่มงานต่อ
